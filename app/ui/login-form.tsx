...
'use client'
import { useFormState, useFormStatus } from 'react-dom' // useFormState 介紹 https://es.react.dev/reference/react-dom/hooks/useFormState
        ...
        <form action={dispatch} className='space-y-3'>
            <div className='flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8'>
                ...
                <div className='w-full'>
                    <div>
                        <label
                            className='mb-3 mt-5 block text-xs font-medium text-gray-900 text-neutral-950'
                            htmlFor='email'
                        >
                            Email
                        </label>
